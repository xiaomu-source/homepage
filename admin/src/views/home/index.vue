    ...
    <section class="zy-home">
        ...
        <section class="one">
            <header class="major">
                ...
                <p>HS·Admin是一个现代化的管理系统，提供了一系列功能丰富的组件和工具，帮助开发者快速搭建和开发管理后台应用。
                  <br>
                  对快速构建Vue3全栈项目有很大的帮助，解决每次新建项目基础配置的烦恼.
                </p>
                <a href="https://gitee.com/xiaomu-source/homepage.git" target="_blank">
                    <a-button type="primary">源码</a-button>
                </a>
                <a href="http://www.askmedo.cn/#/About" target="_blank">
                    <a-button type="primary">个人主页</a-button>
                </a>
            </header>
            <div class="zy-code">
                <code>$ https://gitee.com/xiaomu-source/homepage.git</code>
                <code>$ npm i</code>
