    ...
    <a-layout-content class="login-content">
      <a-row align="middle" justify="center" class="login-content-main">
        <a-col class="login-content-bgc" :pull="1">
          ...
          <p style="margin-top: 15px">✨✨✨ 欢迎使用 {{setting.websiteInfo.name || 'HS·Admin'}}@{{ setting.websiteInfo.version || '1.0.0' }}！</p>
          <p style="margin-top: 15px">
            <a href='https://gitee.com/xiaomu-source/homepage/stargazers'><img
                src='https://gitee.com/xiaomu-source/homepage/badge/star.svg?theme=dark' alt='star'/></a>
            <a href='https://gitee.com/xiaomu-source/homepage/members'><img
                src='https://gitee.com/xiaomu-source/homepage/badge/fork.svg?theme=dark' alt='fork'/></a>
          </p>
        </a-col>
