  ...
  <section class="home-container" id="home">
    ...
    <section class="main-warp" id="about">
      ...
      <section class="main-container">
            ...
            <div class="sidebar" :style="`transform: translateY(-${state.titleAnimation?40:0}%)`">
              <div class="sidebar-card">
                ...
                <div class="sidebar-social">
                  ...
                  <!--                  <a href="https://github.com/xiaomu-source" target="_blank"><i class="iconfont icon-github"></i></a>-->
                  <!--                  <a href="https://github.com/xiaomu-source" target="_blank"><i class="iconfont icon-github"></i></a>-->
                </div>
        ...
        <img  style="display:inline-block" src="https://github-readme-stats.vercel.app/api?username=xiaomu-source&bg_color=30,e96443,904e95&title_color=fff&text_color=fff"
              alt="vuejs" />
        <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=xiaomu-source&amp;layout=compact" alt="TopLangs">
        <img src="https://github-readme-stats.vercel.app/api/pin/?username=xiaomu-source&repo=homepage" alt="TopLangs">
        <img src="https://github-readme-stats.vercel.app/api/pin/?username=xiaomu-source&repo=HS-blog" alt="TopLangs">
        <section class="about">
          <ZySectionHeader title="About me" titleNum="02"/>
          <section class="animate-me">
            "<span class="me-text me-text-a">三年前</span>，我踏上了<span class="me-text me-text-b">后端开发</span>的旅程
            ，从那时起，对后端技术<span class="me-text me-text-c">充满热情</span>，
            ...
            <div class="work-list">
              ...
              <div class="work-item" @click="goToPage('/Portfolio')">
                <img class="work-cover lazy-image"
                     v-bind:data-src="`http://www.askmedo.cn/public/1691545299360.png`">
