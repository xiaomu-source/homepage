      ...
      <div class="blog-l-content">
        <section class="blog-l-info">
          <img class="info-avatar lazy-image"
               data-src="http://www.askmedo.cn/media/avatar.jpg">
...
const backgroundImg = ref('url(http://www.askmedo.cn/public/1691571900783.png)');
...
function updateBackgroundImage() {
  backgroundImg.value = `url(http://www.askmedo.cn/public/${getImageName(currentImageIndex)}.jpg)`;
